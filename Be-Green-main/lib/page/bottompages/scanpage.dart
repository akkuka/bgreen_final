...
import 'package:b_green/page/homepage_add/diseasedetails.dart';
        ...
        ElevatedButton.icon(
          ...
          onPressed: () {
            if (cropcheck == 1) {
              ...
              onUploadImage();
              print(responsefinal);
              if (responsefinal.contains("Not found")) {
                      Navigator.push(context,MaterialPageRoute(builder: (context) => const Diseasedet(
                              id: 0,), ));
                    }
              if (responsefinal.contains("Potato_healthy")) {
                      Navigator.push(context,MaterialPageRoute(builder: (context) => const Diseasedet(
                              id: 0,), ));
                    }
                    if (responsefinal.contains("Potato_late blight")) {
                      Navigator.push(context,MaterialPageRoute(builder: (context) => const Diseasedet(
                              id: 1,), ));
                    }
                    if (responsefinal.contains("Potato_early blight")) {
                      Navigator.push(context,MaterialPageRoute(builder: (context) => const Diseasedet(
                              id: 2,), ));
                    }
            } else {
            ...
            print(responsefinal);
              if (responsefinal.contains("earlyblight")) {
                      Navigator.push(context,MaterialPageRoute(builder: (context) => const Diseasedet(
                              id: 0,), ));
                    }
          },
